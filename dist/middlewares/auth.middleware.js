...
const auth = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(' ')[1]; // Pega o token do cabeçalho de autorização
    if (!token) {
    ...
    try {
        ...
        const payload = yield jose.jwtVerify(token, secret); // Verifica o token
        if (!payload) {

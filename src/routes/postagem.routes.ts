...
import { createPostagem, deletePostagem, findAllPostagens, findPostagemById, updatePostagem } from '../controllers/postagens.controller' // Importa os métodos do controlador
